[PSCustomObject]@{
    Welcome         = "
╔══════════════════════════════════════╗
║ Добро пожаловать в first-store для Windows ║
╚══════════════════════════════════════╝"
    ...
    NewV2           = "Ваша версия Spotify ({0}) не тестировалась. Стабильная версия для first-store — {1}"
    ...
    Spicetify       = "Обнаружен Spicetify, он должен быть установлен после first-store, открыть рекомендуемые действия в FAQ ? [Y/N]"
    NoRestore       = "first-store уже был установлен, но файл для восстановления xpui.bak не найден. `nУдалите клиент Spotify и снова запустите Install.bat"
