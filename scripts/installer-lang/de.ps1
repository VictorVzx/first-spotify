[PSCustomObject]@{
    Welcome         = "
╔══════════════════════════════════╗
║ Willkommen bei first-store für Windows ║
╚══════════════════════════════════╝"
    ...
    NoRestore       = "first-store wurde schon installiert, xpui.bak wurde aber nicht gefunden. `nBitte deinstallieren Sie Spotify und starten Sie Install.bat nochmal"
