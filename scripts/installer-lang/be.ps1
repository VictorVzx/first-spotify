[PSCustomObject]@{
    Welcome         = "
╔════════════════════════════════════════╗
║ Сардэчна запрашаем у first-store для Windows ║
╚════════════════════════════════════════╝"
    ...
    NewV2           = "Ваша версія Spotify ({0}) не была пратэставана. Стабільная версія для first-store — {1}"
    ...
    Spicetify       = "Spicetify выяўлены, ён павінен быць усталяваны пасля first-store, адкрыць рэкамендаваныя дзеянні ў FAQ? [Y/N]"
    NoRestore       = "first-store ужо ўсталяваны, xpui.bak не знойдзены. Калі ласка, выдаліце кліент Spotify і запусціце Install.bat зноў"
