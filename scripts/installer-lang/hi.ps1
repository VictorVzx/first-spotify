[PSCustomObject]@{
    Welcome         = "
╔════════════════════════════════════╗
║ first-store for Windows में आपका स्वागत है  ║
╚════════════════════════════════════╝"
    ...
    NewV2           = "आपके Spotify वर्जन ({0}) को टेस्ट नहीं किया गया है। first-store के लिए स्टेबल वर्जन {1} है"
    ...
    Spicetify       = "Spicetify मिला है। इसे first-store के बाद इंस्टॉल किया जाना चाहिए। क्या आप FAQ में सुझाए गए एक्शन देखना चाहते हैं? [Y/N]"
    NoRestore       = "first-store पहले से इंस्टॉल है, लेकिन xpui.bak नहीं मिला। `nकृपया Spotify क्लाइंट को अनइंस्टॉल करें और Install.bat को फिर से चलाएँ"
